...
namespace FrbaCrucero.AbmCrucero
{
    public partial class AltaCrucero : Frame
    {
        ...
        public AltaCrucero(AbmC _padre)
        {
            InitializeComponent();
        ...
        private void AltaCrucero_FormClosed(object sender, FormClosedEventArgs e)
        {
            this.Hide();
            this.Dispose();
            padre.Show();
        ...
        {
            this.AltaCrucero_FormClosed(sender, new FormClosedEventArgs(CloseReason.UserClosing));
        }
