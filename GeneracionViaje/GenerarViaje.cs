    ...
    public partial class GenerarViaje : Frame
    {
        ...
        private void btnSeleccionarCrucero_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                SeleccionadorComponent sc = new SeleccionadorComponent(consulta, "cruc_id", "cruc_identificador",this);
                sc.ShowDialog();
        ...
        private void btnSeleccionarRecorrido_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                SeleccionadorComponent sc = new SeleccionadorComponent(consulta, "reco_id", "reco_codViejo",this);
                sc.ShowDialog();
